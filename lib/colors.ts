...
export const Colors: colorsType = {
    'red': {
        ...
        bg: {
            normal: 'bg-red-50 dark:bg-red-900',
    ...
    'orange': {
        ...
        bg: {
            normal: 'bg-orange-50 dark:bg-orange-900',
    ...
    'yellow': {
        ...
        bg: {
            normal: 'bg-yellow-50 dark:bg-yellow-900',
    ...
    'green': {
        ...
        bg: {
            normal: 'bg-green-50 dark:bg-green-900',
    ...
    'blue': {
        ...
        bg: {
            normal: 'bg-blue-50 dark:bg-blue-900',
    ...
    'pink': {
        ...
        bg: {
            normal: 'bg-rose-50 dark:bg-rose-900',
    ...
    'purple': {
        ...
        bg: {
            normal: 'bg-indigo-50 dark:bg-indigo-900',
    ...
    'brown': {
        ...
        bg: {
            normal: 'bg-amber-50 dark:bg-amber-900',
