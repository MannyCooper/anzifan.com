...
const NotionBookmark = ({ value }: { value: any }) => {
        ...
        return (
            <Link href={url}>
                <a target="_blank" rel="noopener noreferrer">
                    <div className="my-4 flex text-true-gray-600 bg-light-300 rounded-2xl cursor-pointer h-30 filter group-hover:brightness-90 transition duration-300 ease-in-out ">
                        <div className="w-full  animate-pulse flex">
                            <div className="w-7/10 p-4 flex justify-between flex-col w-full overflow-hidden ">
                                <div className="rounded-lg bg-true-gray-200 h-5 w-2/5  mb-1" />
                                <div className="rounded-md bg-true-gray-200 h-4 w-3/5 mb-2" />
                            ...
                            <div className=" rounded-r-2xl bg-light-500 h-full w-3/10" />
                        </div>
                    </div>
                </a>
            </Link>
    ...
    return (
        ...
        <Link href={url}>
            <a target="_blank" rel="noopener noreferrer">
                <div className="my-4 flex text-true-gray-600 bg-light-300 rounded-2xl cursor-pointer h-30 transition duration-300 ease-in-out filter hover:brightness-90">
                    <div className="w-full flex">
                        ...
                        {images && images.length > 0 && (
                            <div className=" rounded-r-2xl h-full w-3/10 overflow-hidden" >
                                ...
                                <div className="flex justify-center items-center h-full w-3/10 overflow-hidden rounded-r-2xl bg-light-400" >
