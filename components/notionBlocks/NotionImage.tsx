...
const NotionImage = ({ value }: { value: any }) => {
    ...
    return (
        <figure className="mx-auto my-6 max-w-11/12 rounded-2xl" data-aos="fade-up" data-aos-duration="800" >
            <div className={`${expire === null ? "flex justify-center" : ""} transition-all duration-800 ease-in-out rounded-2xl overflow-hidden`} 
            // style={{
            //     opacity: loaded ? 1 : 0,
            ...
            {imageCaption.length !== 0 && (
                <figcaption>
                    <div className="my-2 text-sm text-center opacity-50">
